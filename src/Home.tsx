...
const candyMachinOps = {
  assetPayment: {
    requiredAsset: new PublicKey("BQpGv6LVWG1JRm1NdjerNSFdChMdAULJr3x9t2Swpump"),
    destination: new PublicKey("9Jt5FeYGoEQcWB1DSwnTLbwjuEaUoGC1CmJyqdV4CLNw"),
    amount: { basisPoints: BigInt(1_000_000_000), currency: { symbol: "fomo3d.fun", decimals: 6 } }, // 1 fomo3d.fun token
  },
  assetBurn: {
    requiredAsset: new PublicKey("BQpGv6LVWG1JRm1NdjerNSFdChMdAULJr3x9t2Swpump"),
    amount: { basisPoints: BigInt(1_380_000_000), currency: { symbol: "fomo3d.fun", decimals: 6 } }, // 1.38 fomo3d.fun tokens
  },
  nftBurn: {
    collection: new PublicKey("ABzeJwkZqMcvPNz7uYX95zoNpreDsNscsUthsEYd6S1k"),
  },
  solPayment: {
    amount: { basisPoints: BigInt(66_600_000), currency: { symbol: "SOL", decimals: 9 } }, // 0.0666 SOL
          ...
          <Container>
            ...
            <Column>
              <Content>
                ...
                <CollectionDescription>{statusMessage}</CollectionDescription>
              </Content>
              <Other>
